                                        ...
                                        <div class="mb-0 p-0 p-lg-3">
                                            ...
                                            <div class="mb-0 border-0 p-md-4 p-lg-0">
                                                ...
                                                <div class="auth-title-section mb-4 text-lg-start text-center"> 
                                                    ...
                                                    <p class="text-muted fs-14 mb-0">Sign up to unlock exclusive content, special offers, and be the first to know about exciting updates.</p>
                                                </div>
                                                ...
                                                <div class="pt-0">
                                                    ...
                                                    <div class="text-center text-muted mb-0">
                                                        <p class="mb-0">Already have an account ?<a class='text-primary ms-2 fw-medium' href='auth-login.php'>Login here</a></p>
                                                    </div>
