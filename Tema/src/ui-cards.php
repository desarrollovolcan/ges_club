                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-xl-3">
                                ...
                                <div class="card d-block">
                                    <img class="card-img-top rounded-top" src="assets/images/small/img-1.jpg" alt="Card image cap">
                                    <div class="card-body">
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div class="card d-block">
                                    <img class="card-img-top rounded-top" src="assets/images/small/img-2.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title">Card title</h4>
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div class="card d-block">
                                    <img class="card-img-top rounded-top" src="assets/images/small/img-3.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <p class="card-text text-muted">Some quick example text to build on the card title and make
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="card">
                                    <img class="card-img-top rounded-top" src="assets/images/small/img-5.jpg" alt="Card image top">
                                    <div class="card-body">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card">
                                    ...
                                    <img class="card-img-bottom rounded-bottom" src="assets/images/small/img-7.jpg" alt="Card image bottom">
                                </div> <!-- end card -->
                            </div><!-- end col -->

                            <div class="col-lg-4 col-md-6">
                                <div class="card text-bg-dark">
                                    <img class="card-img rounded"  src="assets/images/small/img-6.jpg" alt="Card image overlay">
                            ...
                            <div class="col-12">
                                <div class="card-deck-wrapper">
                                    <div class="card-group">
                                        ...
                                        <div class="card">
                                            <img class="card-img-top img-fluid" src="assets/images/small/img-9.jpg" alt="Card image cap">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text text-muted">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                                <p class="card-text"><small class="text-body-secondary">Last updated 3 mins ago</small></p>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="row row-cols-1 row-cols-md-2">
                                    <div class="col">
                                        <div class="card">
                                            <img src="assets/images/small/img-6.jpg" class="card-img-top rounded-top" alt="grid card">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text text-muted">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <img src="assets/images/small/img-7.jpg" class="card-img-top rounded-top" alt="grid card">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text text-muted">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <img src="assets/images/small/img-5.jpg" class="card-img-top rounded-top" alt="grid card">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text text-muted">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <img src="assets/images/small/img-4.jpg" class="card-img-top rounded-top" alt="grid card">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text text-muted">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <img src="assets/images/small/img-1.jpg" class="card-img-top rounded-top" alt="grid card">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text text-muted">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <img src="assets/images/small/img-3.jpg" class="card-img-top rounded-top" alt="grid card">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
