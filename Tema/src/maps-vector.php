...
<html lang="en">
    ...
    <?php include 'partials/body.php'; ?>
        ...
        <script src="assets/js/pages/us-mill-en-map.js"></script>
        <script src="assets/js/pages/spain-map.js"></script>
        <script src="assets/js/pages/russia-map.js"></script>
        <script src="assets/js/pages/canada-map.js"></script>
        <script src="assets/js/pages/iraq-map.js"></script> 
