...
<html lang="es">
    <head>
        ...
        <title><?php echo htmlspecialchars($title ?? 'Iniciar sesión', ENT_QUOTES, 'UTF-8'); ?></title>
                                        ...
                                        <div class="mb-0 p-0 p-lg-3">
                                            <div class="mb-0 border-0 p-md-4 p-lg-0">
                                                ...
                                                <div class="auth-title-section mb-4 text-lg-start text-center">
                                                    <h3 class="text-dark fw-semibold mb-3">Bienvenido(a). Inicia sesión para continuar.</h3>
                                                    <p class="text-muted fs-14 mb-0">Accede a la administración de tu club deportivo y gestiona socios, finanzas y actividades.</p>
                                                </div>
                                                ...
                                                <div class="saprator my-4"><span>o continúa con tu correo</span></div>

                                                <div class="pt-0">
                                                    <form method="#" class="my-4">
                                                        <div class="form-group mb-3">
                                                            <label for="emailaddress" class="form-label">Correo electrónico</label>
                                                            <input class="form-control" type="email" id="emailaddress" name="email" required placeholder="Ingresa tu correo">
                                                        </div>
                                                        ...
                                                        <div class="form-group d-flex mb-3">
                                                            ...
                                                            <div class="col-sm-6 text-end">
                                                                <a class="text-muted fs-14" href="#">¿Olvidaste tu contraseña?</a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-0 row">
                                                            <div class="col-12">
                                                                <div class="d-grid">
                                                                    <button class="btn btn-primary fw-semibold" type="submit">Ingresar</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                                    ...
                                                    <div class="text-center text-muted">
                                                        <p class="mb-0">¿No tienes cuenta?<a class="text-primary ms-2 fw-medium" href="#">Regístrate</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item active">
                                            <p class="prelead mb-2">
                                                ...
                                                La plataforma centraliza la administración del club para que tu equipo trabaje con información clara y actualizada.
                                            ...
                                            <h4 class="mb-1">Equipo GES Club</h4>
                                            <p class="mb-0">Administración deportiva</p>
                                        </div>

                                        <div class="carousel-item">
                                            <p class="prelead mb-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><path fill="#ffffff" d="M4.583 17.321C3.553 16.227 3 15 3 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621c.537-.278 1.24-.375 1.929-.311c1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 0 1-3.5 3.5a3.87 3.87 0 0 1-2.748-1.179m10 0C13.553 16.227 13 15 13 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621c-.537-.278 1.24-.375 1.929-.311c1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 0 1-3.5 3.5a3.87 3.87 0 0 1-2.748-1.179"/></svg>
                                                Configura roles y permisos para que entrenadores, tesoreros y socios accedan a lo que necesitan.
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><path fill="#ffffff" d="M19.417 6.679C20.447 7.773 21 9 21 10.989c0 3.5-2.456 6.637-6.03 8.188l-.893-1.378c3.335-1.804 3.987-4.145 4.248-5.621c-.537.278-1.24.375-1.93.311c-1.804-.167-3.226-1.648-3.226-3.489a3.5 3.5 0 0 1 3.5-3.5c1.073 0 2.1.49 2.748 1.179m-10 0C10.447 7.773 11 9 11 10.989c0 3.5-2.456 6.637-6.03 8.188l-.893-1.378c3.335-1.804 3.987-4.145 4.247-5.621c-.537.278-1.24.375-1.929.311C4.591 12.323 3.17 10.842 3.17 9a3.5 3.5 0 0 1 3.5-3.5c1.073 0 2.1.49 2.748 1.179"/></svg>
                                            </p>
                                            <h4 class="mb-1">Equipo Técnico</h4>
                                            <p class="mb-0">Gestión deportiva</p>
                                        </div>

                                        <div class="carousel-item">
                                            <p class="prelead mb-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><path fill="#ffffff" d="M4.583 17.321C3.553 16.227 3 15 3 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621c.537-.278 1.24-.375 1.929-.311c1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 0 1-3.5 3.5a3.87 3.87 0 0 1-2.748-1.179m10 0C13.553 16.227 13 15 13 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621c-.537-.278 1.24-.375 1.929-.311c1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 0 1-3.5 3.5a3.87 3.87 0 0 1-2.748-1.179"/></svg>
                                                Controla cuotas sociales, pagos y reportes financieros sin perder trazabilidad.
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><path fill="#ffffff" d="M19.417 6.679C20.447 7.773 21 9 21 10.989c0 3.5-2.456 6.637-6.03 8.188l-.893-1.378c3.335-1.804 3.987-4.145 4.248-5.621c-.537.278-1.24.375-1.93.311c-1.804-.167-3.226-1.648-3.226-3.489a3.5 3.5 0 0 1 3.5-3.5c1.073 0 2.1.49 2.748 1.179m-10 0C10.447 7.773 11 9 11 10.989c0 3.5-2.456 6.637-6.03 8.188l-.893-1.378c3.335-1.804 3.987-4.145 4.247-5.621c-.537.278-1.24.375-1.929.311C4.591 12.323 3.17 10.842 3.17 9a3.5 3.5 0 0 1 3.5-3.5c1.073 0 2.1.49 2.748 1.179"/></svg>
                                            </p>
                                            <h4 class="mb-1">Tesorería</h4>
                                            <p class="mb-0">Gestión financiera</p>
                                        </div>
